import SidebarButtonComponent from './components/ButtonComponents/SidebarButtonComponent';
...
function App() {
  return (
    ...
    <div class="drawer drawer-mobile justify-center">
      ...
      <div class="drawer-content flex overflow-x-hidden scrollbar-hide">
        <Home />
      </div>
      {/* MAIN PAGE CONTENTS END */}

      {/* LEFT SIDE DRAWER CONTENTS START */}
      <div class="drawer-side">
        <label for="my-drawer-2" class="drawer-overlay"></label>
        <ul class="menu px-2 overflow-y-auto xl:w-68 lg:w-24 zero:w-68 bg-base-100 text-base-content">
          {/* SIDE DRAWER CONTENTS */}
          <li>
            <a class="py-2 rounded-full w-min">
              <svg
                viewBox="0 0 24 24"
                class="xl:h-10 xl:w-8 lg:w-10 lg:h-12 zero:w-8 zero:h-10 flex fill-current cursor-pointer hover:bg-"
                aria-hidden
              >
                <g>
          ...
          <li>
            <a class="font-bold">
              <div class="flex">
                <svg
                  viewBox="0 0 24 24"
                  class="xl:h-8 xl:w-6 lg:h-10 lg:w-8 zero:w-6 zero:h-8 flex fill-current"
                  aria-hidden
                >
                  <g>
                ...
                <span class="badge badge-primary indicator-item xl:h-1.5 xl:w-1.5 lg:h-2 lg:w-2 zero:w-1.5 zero:h-1.5 rounded p-0 relative right-2"></span>
              </div>
              <p class="xl:block lg:hidden">Home</p>
            </a>
          </li>
          <li>
            <a>
              <SidebarButtonComponent element={'Explore'}>
          ...
          <li>
            <a class="gap-0">
              <div class="flex">
                ...
                <span class="badge badge-primary indicator-item xl:h-4 xl:w-4 lg:h-5 lg:w-5 zero:w-4 zero:h-4 rounded-1/2 p-0 relative right-3 text-xs">
                  2
                </span>
              </div>
              <p class="xl:block lg:hidden">Notifications</p>
            </a>
          </li>
          <li>
            <a>
              <SidebarButtonComponent element={'Messages'}>
          ...
          <li>
            <a>
              <SidebarButtonComponent element={'Bookmarks'}>
          ...
          <li>
            <a>
              <SidebarButtonComponent element={'Lists'}>
          ...
          <li>
            <a>
              <SidebarButtonComponent element={'Profile'}>
          ...
          <li>
            <a>
              <SidebarButtonComponent element={'More'}>
          ...
          <li class="hover:bg-black lg:hidden xl:block">
            <a class="hover:bg-black">
              <div class="btn btn-primary normal-case font-bold rounded-full w-full text-base">
                Tweet
              </div>
            </a>
          </li>
          <li class="mt-auto mb-3">
            <a class="rounded-full justify-between">
              <div class="flex">
                <div class="avatar">
                  <div class="xl:h-10 xl:w-10 lg:h-14 lg:w-14 zero:w-10 zero:h-10 rounded-full">
                    <img src="https://i.imgur.com/iDJzduO.jpg" />
                  </div>
                  <div class="flex">
                    <p class="font-bold text-sm ml-3 lg:hidden xl:block zero:block">
                      Bhavya Gosai
                    </p>
                    <p class="text-sm ml-3 text-secondary-content lg:hidden xl:block zero:bloc">
                      @bbsempaii
                    </p>
                  </div>
                </div>
              </div>
              <p class="font-bold lg:hidden xl:block zero:bloc">···</p>
            </a>
          </li>
        </ul>
      </div>
      {/* LEFT SIDE DRAWER CONTENTS END */}
    </div>
  );
}
