import TweetButtonComponent from '../ButtonComponents/TweetButtonComponent';

const TweetComponent = () => {
  return (
    <div class="lg:border-b lg:border-x lg:flex lg:flex-col lg:px-4 lg:py-1 lg:min-w-0 hidden">
      <div class="flex w-full">
        <div class="avatar cursor-pointer filter hover:brightness-90">
          <div class="w-12 h-12 rounded-full">
            <img src="https://i.imgur.com/iDJzduO.jpg" />
          </div>
        </div>
        <span
          class="textarea textarea-ghost text-xl w-[calc(100%-2rem)] mt-1 
      ...
      <div class="flex text-primary ml-15 mt-5 mb-2 w-[calc(100%-4rem)]">
        ...
        <button
          id="tweetButton"
          class="btn-sm btn-primary normal-case font-bold rounded-full text-md ml-auto btn-disabled px-4"
        >
          Tweet
        </button>
      </div>
